...
* [Search with a regular expression](#Search-with-a-regular-expression)
   ...
   | [`matchEntire`](#matchEntire--finds-out-does-the-regular-expression-match-the-whole-text-returns-a-parameter) | Finds out does the regular expression match the whole text. Returns a match parameter. |
...
* Find out does your regular expression match the whole text; depending on the applied function, you can get a certain match parameter ([`matches`](#matches--finds-out-does-the-regular-expression-match-the-whole-text-returns-a-parameter)) or a Boolean value ([`matchEntire`](#matchEntire--finds-out-does-the-regular-expression-match-the-whole-text-returns-a-Booolean-value)).
